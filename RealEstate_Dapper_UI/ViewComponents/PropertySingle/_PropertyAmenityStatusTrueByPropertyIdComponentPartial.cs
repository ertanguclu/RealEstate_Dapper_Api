...
namespace RealEstate_Dapper_UI.ViewComponents.PropertySingle
{
    public class _PropertyAmenityStatusTrueByPropertyIdComponentPartial : ViewComponent
    {
        ...
        {
            var client = _httpClientFactory.CreateClient("RealEstateAPIClient");
            var responseMessage = await client.GetAsync("https://localhost:44352/api/PropertyAmenities?id=1");
